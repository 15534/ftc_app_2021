...
public class RedB extends RedAuto {
    ...
    public void buildTrajectories() {
        ...
        dropOffWobbleGoal = drive.trajectoryBuilder(launchPosition.end().plus(new Pose2d(0,0, Math.toRadians(20))))
                .splineToSplineHeading(new Pose2d(26, -30, Math.toRadians(-90)), Math.toRadians(0))
                .addSpatialMarker(new Vector2d(22, -30), wobble::release)
                .build();
        ...
        pickUp3RingsIntermediatePoint = drive.trajectoryBuilder(dropOffWobbleGoal.end(), Math.toRadians(90))
                ...
                .splineToConstantHeading(new Vector2d(26,-14), Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(-13.5159, -49.479, Math.toRadians(110)), Math.toRadians(180))
                .build();
...
//                .build();
        ...
        goOverLaunchLine = drive.trajectoryBuilder(dropOffSecondWobbleGoal.end(), Math.toRadians(90))
                .addTemporalMarker(0, shooter::stickDown)
                .splineToConstantHeading(new Vector2d(14, -15), Math.toRadians(90))
                .build();
    }
